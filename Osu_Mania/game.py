...
class Window:    
    def __init__(self):
        ...
        self.i = []
        self.scrollspeed = 35
        self.Memories = Map.Map(650, 550, "Osu Mania Memories", "OsuManiaMemories.txt", "hard", 15, self)
        self.Aldnoah = Map.Map(400, 500, "Oshama Scramble", "OshamaScramble.txt", "hard", 15, self)
        self.Monogatari = Map.Map(650, 500,"Kimi no Shiranai...", "monogatari.txt", "hard", 15, self)
        self.DroptheFire = Map.Map(900, 500, "SiliconXX", "S3RL.txt", "hard", 15, self)
        self.maps = [self.Aldnoah, self.Monogatari, self.DroptheFire, self.Memories]
        self.endtime = 0
        """
    ...
    def on_draw(self):
        ...
        if self.select:
            ...
            textSize(60)
            fill(255, 255, 255)
            text("Pick a Map", 650, 100)
            textSize(40)
            text("RNG Maps", 650, 160)
            text("Real Osu! Mania Maps", 650, 420)
            textSize(50)
            ...
            text("Change speed with +/-", 650, 630)
            textSize(50)
    ...
    def on_mouse_clicked(self, mouseX, mouseY):
        for maps in self.maps:
            maps.on_mouse_clicked(mouseX, mouseY)
